...
from scripts.SafeUtils import evaluate_policy


class PPOCallback(BaseCallback):
    def __init__(self, verbose=0, save_path='default', save_path_plot='default_plot', eval_env=None):
        ...
        self.save_path_plot = save_path_plot
        self.eval_steps = []
        self.eval_rewards = []
    ...
    def _on_training_end(self) -> None:
        ...
        plt.savefig(self.save_path_plot + '.png')
